...
# Getting the spreadsheet ids from our .env file
...
# Getting the individual sheets from the Google Spreadsheets
...
@router.patch('/change_status/{room_id}')
async def update_item(room_id: int, item: RoomInfo):
